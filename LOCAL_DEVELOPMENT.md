...
- Admin reviewers can inspect staged external results at `/admin/external-results` once their Auth0 session includes `matches:finalize`; pending rows can be confirmed or discarded, and confirmed/discarded rows can be reviewed with the state filters.
