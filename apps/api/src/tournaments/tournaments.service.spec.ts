...
describe('TournamentsService', () => {
  ...
  it('throws when the active tournament is missing', async () => {
    ...
    await expect(service.getActiveTournament()).rejects.toThrow('Active tournament not found');
  });
  ...
  it('returns active tournament matches ordered by kickoff time with team data', async () => {
    ...
    expect(matches).toEqual([toMatchView(firstMatch), toMatchView(secondMatch)]);
