          ...
          <div className="w-full rounded-[2rem] border border-slate-800/80 bg-slate-900/70 p-6 shadow-2xl shadow-cyan-950/20 backdrop-blur sm:p-8">
            ...
            <section className="mt-8 rounded-3xl border border-cyan-400/20 bg-cyan-400/10 p-5">
              <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                <div>
                  <p className="text-xs uppercase tracking-[0.2em] text-cyan-300">{t("scoringRules.eyebrow")}</p>
                  <h2 className="mt-1 text-base font-semibold text-white">{t("scoringRules.title")}</h2>
                  <p className="mt-2 max-w-2xl text-sm leading-6 text-cyan-100/75">{t("scoringRules.description")}</p>
                </div>
              </div>
              ...
              <div className="mt-5 grid gap-3 md:grid-cols-3">
                <div className="rounded-2xl border border-cyan-300/25 bg-slate-950/55 p-4">
                  ...
                  <p className="mt-2 text-sm font-bold text-white">{t("scoringRules.exactScoreTitle")}</p>
                  <p className="mt-1 text-xs leading-5 text-cyan-100/70">{t("scoringRules.exactScoreDetail")}</p>
                </div>
                <div className="rounded-2xl border border-emerald-300/25 bg-slate-950/55 p-4">
                  ...
                  <p className="mt-2 text-sm font-bold text-white">{t("scoringRules.correctOutcomeTitle")}</p>
                  <p className="mt-1 text-xs leading-5 text-emerald-100/70">{t("scoringRules.correctOutcomeDetail")}</p>
                </div>
                <div className="rounded-2xl border border-rose-300/25 bg-slate-950/55 p-4">
                  <p className="text-3xl font-black text-rose-200">0</p>
                  <p className="mt-2 text-sm font-bold text-white">{t("scoringRules.wrongOutcomeTitle")}</p>
                  <p className="mt-1 text-xs leading-5 text-rose-100/70">{t("scoringRules.wrongOutcomeDetail")}</p>
                </div>
              </div>
            </section>
          </div>
